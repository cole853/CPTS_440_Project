...
class KNN_Wrapper:
    ...
    # initializes an instance of KNN_Wrapper
    # predictors is a list of column names used to predict values
    # name is the name of the report file that will be generated
    # n_neighbors is the number of neighbors to be considered
    # weights uses the distance of neighbors when set to 'distance' can be set to 'uniform' to remove weights.
    ...
    #   0 otherwise
    def __init__(self, predictors, name="", n_neighbors=5, weights='distance', confidence=0.5):
    ...
    def writeReport(self, string, noNewline=False):
        ...
        file_path = os.path.join("Reports", str(self.name) + "_KNN.txt")
    ...
    def writeFullReport(self):
        ...
        self.writeReport("n_neighbors:\t\t\t" + str(self.n_neighbors))
        self.writeReport("weights:\t\t\t\t" + str(self.weights) + "\n")
